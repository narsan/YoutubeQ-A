...
export default class Channel extends TabbedFeed {
    ...
    getAbout() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (((_a = this.header) === null || _a === void 0 ? void 0 : _a.is(C4TabbedHeader)) && this.header.tagline) {
                if (this.header.tagline.more_endpoint instanceof NavigationEndpoint) {
                    const response = yield this.header.tagline.more_endpoint.call(this.actions);
                    const tab = new TabbedFeed(this.actions, response, false);
                    return tab.memo.getType(ChannelAboutFullMetadata)[0];
                }
                const endpoint = (_c = (_b = this.page.header_memo) === null || _b === void 0 ? void 0 : _b.getType(ContinuationItem)[0]) === null || _c === void 0 ? void 0 : _c.endpoint;
                if (!endpoint) {
    ...
    get has_about() {
        ...
        return this.hasTabWithURL('about') || !!(((_a = this.header) === null || _a === void 0 ? void 0 : _a.is(C4TabbedHeader)) && ((_b = this.header.tagline) === null || _b === void 0 ? void 0 : _b.more_endpoint));
    }
    get has_search() {
        var _a;
