...
class VideoInfo {
    constructor(data, actions) {
        ...
        this.watch_next_feed = (_a = watchNext.entries) === null || _a === void 0 ? void 0 : _a.array();
        __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation, (_b = watchNext.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
    }
    /**
    ...
    getWatchNextContinuation() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation, (_b = parsed.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
            return this;
        });
    }
}
