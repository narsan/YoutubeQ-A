...
var ChannelExternalLinkView = class extends YTNode {
  constructor(data) {
    ...
    this.favicon = data.favicon.sources.map((x) => new Thumbnail(x)).sort((a, b) => b.width - a.width);
  }
};
...
var Playlist = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text2(data.title);
    this.author = ((_a3 = data.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text2(data.shortBylineText) : new Author(data.longBylineText, data.ownerBadges, null);
...
var GridMix = class extends YTNode {
  constructor(data) {
    ...
    this.id = data.playlistId;
    this.title = new Text2(data.title);
    this.author = ((_a3 = data.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text2(data.shortBylineText) : ((_b = data.longBylineText) === null || _b === void 0 ? void 0 : _b.simpleText) ? new Text2(data.longBylineText) : null;
    this.thumbnails = Thumbnail.fromResponse(data.thumbnail);
    this.video_count = new Text2(data.videoCountText);
    this.video_count_short = new Text2(data.videoCountShortText);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
...
var ItemSection = class extends YTNode {
  constructor(data) {
    var _a3, _b, _c;
    super();
    this.header = parser_exports.parseItem(data.header, [CommentsHeader_default, ItemSectionHeader_default, ItemSectionTabbedHeader_default]);
    this.contents = parser_exports.parseArray(data.contents);
...
var MusicMultiSelectMenu = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "title") && Reflect.has(data.title, "musicMenuTitleRenderer")) {
      this.title = new Text2((_a3 = data.title.musicMenuTitleRenderer) === null || _a3 === void 0 ? void 0 : _a3.primaryText);
    }
...
var PlaylistPanelVideo = class extends YTNode {
  constructor(data) {
    ...
    const album = (_a3 = new Text2(data.longBylineText).runs) === null || _a3 === void 0 ? void 0 : _a3.find((run) => {
      var _a4, _b2, _c2;
...
var VideoPrimaryInfo = class extends YTNode {
  constructor(data) {
    ...
    this.view_count = new Text2((_b = (_a3 = data.viewCount) === null || _a3 === void 0 ? void 0 : _a3.videoViewCountRenderer) === null || _b === void 0 ? void 0 : _b.viewCount);
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "8.0.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
