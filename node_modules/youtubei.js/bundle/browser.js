...
var ClipCreationScrubber = class extends YTNode {
  constructor(data2) {
    ...
    this.start_label = (_b = (_a3 = data2.startAccessibility) === null || _a3 === void 0 ? void 0 : _a3.accessibilityData) === null || _b === void 0 ? void 0 : _b.label;
...
var VideoAttributeView = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    if ((_a3 = data2.image) === null || _a3 === void 0 ? void 0 : _a3.sources) {
      this.image = {
        sources: data2.image.sources.map((x) => new Thumbnail(x)).sort((a, b) => b.width - a.width)
      };
    } else {
...
var CompactVideo = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "richThumbnail")) {
      this.rich_thumbnail = parser_exports.parse(data2.richThumbnail);
    }
    this.title = new Text2(data2.title);
...
var ChannelExternalLinkView = class extends YTNode {
  constructor(data2) {
    ...
    this.favicon = data2.favicon.sources.map((x) => new Thumbnail(x)).sort((a, b) => b.width - a.width);
  }
};
...
var Command = class extends YTNode {
  constructor(data2) {
    super();
    this.endpoint = new NavigationEndpoint_default(data2);
  }
};
...
var Playlist = class extends YTNode {
  constructor(data2) {
    ...
    this.title = new Text2(data2.title);
    this.author = ((_a3 = data2.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text2(data2.shortBylineText) : new Author(data2.longBylineText, data2.ownerBadges, null);
...
var ItemSection = class extends YTNode {
  constructor(data2) {
    var _a3, _b, _c;
    super();
    this.header = parser_exports.parseItem(data2.header, [CommentsHeader_default, ItemSectionHeader_default, ItemSectionTabbedHeader_default]);
    this.contents = parser_exports.parseArray(data2.contents);
...
var LiveChatTickerPaidMessageItem = class extends YTNode {
  constructor(data2) {
    ...
    this.show_item = parser_exports.parseItem((_b = (_a3 = data2.showItemEndpoint) === null || _a3 === void 0 ? void 0 : _a3.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
...
var ReplayChatItemAction = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    this.actions = parser_exports.parseArray((_a3 = data2.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
...
var MultiPageMenu = class extends YTNode {
  constructor(data2) {
    super();
    this.header = parser_exports.parse(data2.header);
    this.sections = parser_exports.parse(data2.sections);
    this.style = data2.style;
  }
};
...
var SimpleMenuHeader = class extends YTNode {
  constructor(data2) {
    super();
    this.title = new Text2(data2.title);
    this.buttons = parser_exports.parse(data2.buttons);
  }
};
...
var ReelPlayerOverlay = class extends YTNode {
  constructor(data2) {
    ...
    this.subscribe_button_renderer = parser_exports.parseItem(data2.subscribeButtonRenderer, Button_default);
    this.style = data2.style;
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data2) {
    ...
    this.results = parser_exports.parseArray((_a3 = data2.results) === null || _a3 === void 0 ? void 0 : _a3.results.contents);
...
function parseResponse(data2) {
  ...
  _clearMemo();
  _createMemo();
  const entries = parse(data2.entries);
  if (entries) {
  ...
  const continuationEndpoint = data2.continuationEndpoint ? parseLC(data2.continuationEndpoint) : null;
...
var MediaInfo = class {
  constructor(data2, actions, cpn) {
    ...
    const info = parser_exports.parseResponse(data2[0].data);
    const next = ((_a3 = data2 === null || data2 === void 0 ? void 0 : data2[1]) === null || _a3 === void 0 ? void 0 : _a3.data) ? parser_exports.parseResponse(data2[1].data) : void 0;
...
var VideoInfo3 = class {
  constructor(data2, actions) {
    ...
    const info = parser_exports.parseResponse(data2[0].data);
    const watchNext = parser_exports.parseResponse(data2[1].data);
    this.basic_info = info.video_details;
    this.watch_next_feed = (_a3 = watchNext.entries) === null || _a3 === void 0 ? void 0 : _a3.array();
    __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation2, (_b = watchNext.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
  }
  getWatchNextContinuation() {
    var _a3, _b;
    return __awaiter(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet(this, _VideoInfo_watch_next_continuation2, "f"))
        throw new InnertubeError("Watch next feed continuation not found");
      const response = yield __classPrivateFieldGet(this, _VideoInfo_actions, "f").execute(reel_exports.WatchSequenceEndpoint.PATH, reel_exports.WatchSequenceEndpoint.build({
        sequenceParams: __classPrivateFieldGet(this, _VideoInfo_watch_next_continuation2, "f").token
      }));
      if (!response.success) {
      ...
      __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation2, (_b = parsed.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
      return this;
    });
  }
};
